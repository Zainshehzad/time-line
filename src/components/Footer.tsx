...
function Footer() {
    return (
      <footer className="bg-blacktext-gray-400 py-12  bottom-0 left-0 w-full">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul>
              <li><a href="https://github.com/zainshahzad" className="hover:text-white">Github</a></li>
              <li><a href="https://vercel.com/editzzain-projects" className="hover:text-white">Portfolio</a></li>
          ...
          <div>
            ...
            <p>Email: <a href="mailto:contact@c2tec.com" className="hover:text-white">zainshahzad2121@gmail.com</a></p>
            <p>Phone: <span className="hover:text-white">0325 1540140</span></p>
          </div>
        </div>
