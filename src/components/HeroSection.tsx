...
function HeroSection() {
  return (
    ...
    flex-col items-center justify-center relative overflow-hidden  mx-auto py-5 md:py-0 '>
 <div className='p-6 relative text-white z-10 w-full text-center'>
 <Spotlight
...
<div className="mt-4">
    <Link href={'/courses'}>
     ...
     className="bg-black-10 dark:bg-slate-900 text-white dark:text-white border-black dark:border-slate-400"
     >
     Explore courses
     </Button>
    </Link>
