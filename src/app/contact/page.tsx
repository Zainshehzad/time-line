...
const ContactPage = () => {
  return (
    <div className="min-h-screen bg-[#0a0e27] py-12 pt-36 relative overflow-hidden flex justify-center items-center">
      ...
      <div className="flex bg-[#34522] bg-opacity-60 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="hidden md:flex items-center justify-center w-1/2">
          <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-gray-500">
            <Image
              src={avaImage}
              alt="Contact Us"
              fill
